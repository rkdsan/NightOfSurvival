...
public class SaveManager : MonoBehaviour
{
    ...
    private void SaveLampData()
    {
        ...
        var dic = LampManager.instance.allLampDictionary;
        ...
        {
            data.id[i] = i;
            data.isOn[i] = dic[i].lampLight.enabled;
        }
    ...
    private void LoadLampData()
    {
        var data = new LampData();
        data = LoadJsonData<LampData>(data.typeName);
        var dic = LampManager.instance.allLampDictionary;

        Debug.Log("딕셔너리 크기: " + dic.Count);
